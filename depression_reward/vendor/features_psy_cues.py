...
class FeaturesPsyCues(BaseFeaturesExtractor):
    ...
    def __call__(self, text, lemma_mys, postag_mys_unconverted) -> dict:
        ...
        features['pro_1p_sing_rate'] = pro_1p_single / postags_count['postag_SPRO'] if postags_count[
            'postag_SPRO'] else 0
        features['pro_1p_plural_rate'] = pro_1p_plural / postags_count['postag_SPRO'] if postags_count[
            'postag_SPRO'] else 0
        ...
        features['verbs_per_nouns_coef'] = postags_count['postag_V'] / postags_count['postag_S'] if postags_count[
            'postag_S'] else 0
